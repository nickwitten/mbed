...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1642195180.8876762
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1642195180.8876762
...
ASM_FLAGS += -include
ASM_FLAGS += /filer/workspace_data/exports/c/c12a4c2f64f3ac1d2e90dbd0bfbbbcda/4180_Lab1/mbed_config.h
ASM_FLAGS += -c
ASM_FLAGS += -x
ASM_FLAGS += assembler-with-cpp
ASM_FLAGS += -Wall
